 ...
 */
const p256_int fixed_d = {{0x2AD5EEBB, 0x15E31174, 0x8C21CBFA, 0xB59773BD,
                           0x3E296192, 0x5FF3F73E, 0x01DF7E79, 0x947F8898}};

/* SHA256 H("Google Google Google"). No terminating Null. */
const p256_int test_msg = {{0x9fda1d90, 0x9c73eca1, 0x9e7365e3, 0xeaf6c93f,
...
const p256_int fixed_k = {{0xCCF7C3FD, 0xB53EF2AB, 0x7B5F036E, 0x58431BE9,
                           0x58F59D47, 0x87CBC945, 0xCE54555E, 0x520D2764}};

const p256_int fixed_r = {{0x90b3bc00, 0xf92caa14, 0xfa9c9747, 0x72ef4d27,
                           0xf1c79a10, 0x613af428, 0x012e1484, 0xc145c17b}};
const p256_int fixed_s = {{0x6b9e4254, 0x799c70af, 0xc89e8923, 0x0d225f87,
...
static const uint8_t nonce0[] = {0xd0, 0x71, 0x54, 0x4e, 0x59, 0x92,
                                 0x35, 0xd5, 0xeb, 0x38, 0xb6, 0x4b,
                                 0x55, 0x1d, 0x2a, 0x6e};
static const uint8_t perso0[] = {
...
static const uint32_t K0[] = {0x7fe2b43a, 0x94f11b33, 0x2b76c5ce, 0xfbb784af,
                              0x81cfe716, 0xc43596d6, 0xbdfe968b, 0x189c80fb};
static const uint32_t V0[] = {0xc42b237a, 0x929cdd0b, 0xe7fbafdd, 0xba22a36a,
                              0x4d23471a, 0xd8607022, 0x687e18ac, 0x2ac08007};

// Reseed
static const uint8_t entropy1[] = {
...
static const uint8_t addtl_input1[] = {
...
static const uint32_t K1[] = {0x3118D36E, 0x05DEEC48, 0x7EFB6363, 0x3D575CDE,
                              0xCFCD14C1, 0x8D4F937D, 0x896B811E, 0x0EF038EB};
// may need to reverse byte ordering
static const uint32_t V1[] = {0xC8ED8EEC, 0x24DD7B66, 0x09C635CD, 0x6AC74196,
                              0xC70067D7, 0xC2E71FEF, 0x918D9EB7, 0xAE0CD544};

// Generate
static const uint32_t K2[] = {0x980ccd6a, 0x0b34f7e1, 0x594aabd7, 0x33b66049,
                              0xb919bd57, 0x8ecc7194, 0xaf1748a3, 0x80982577};

static const uint32_t V2[] = {0xe4927cdb, 0xb3435cc5, 0x601ab870, 0x46e1f024,
                              0x966ca875, 0x102b4167, 0xa71e5dce, 0xe4c15962};

// Reseed, prediction resistance
static const uint8_t entropy2[] = {
...
static const uint8_t addtl_input2[] = {
...
int fips_aes128_kat(void) {
  static const uint8_t k[AES256_BLOCK_CIPHER_KEY_SIZE] = /* "etaonrishd" */
      {0x65, 0x74, 0x61, 0x6f, 0x6e, 0x72, 0x69, 0x73, 0x68, 0x64, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

  static const uint8_t msg[AES_BLOCK_LEN] = {0x00, 0xAA, 0x00, 0xAA, 0x00, 0xAA,
...
int fips_hmac_sha256_kat(void) {
  static const uint8_t k[SHA256_DIGEST_SIZE] = /* "etaonrishd" */
      {0x65, 0x74, 0x61, 0x6f, 0x6e, 0x72, 0x69, 0x73, 0x68, 0x64, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  static const uint8_t in[] = /* "Sample text" */
...
int fips_sha256_kat(void) {
  static const uint8_t in[] = /* "etaonrishd" */
