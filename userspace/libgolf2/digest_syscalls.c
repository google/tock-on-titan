...
#define TOCK_DIGEST_CMD_INITIALIZE 1
#define TOCK_DIGEST_CMD_UPDATE     2
#define TOCK_DIGEST_CMD_FINALIZE   3
#define TOCK_DIGEST_CMD_BUSY       4
#define TOCK_DIGEST_CMD_CERT_INIT  5
