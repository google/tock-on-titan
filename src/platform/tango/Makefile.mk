...
$(BUILD_PLATFORM_DIR)/kernel.o: $(call rwildcard,$(SRC_DIR)platform/tango,*.rs) $(BUILD_PLATFORM_DIR)/libhotel.rlib $(PLATFORM_DEPS) | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
	@$(RUSTC) $(RUSTC_FLAGS) -C lto --emit obj -o $@ $(SRC_DIR)platform/tango/src/main.rs
