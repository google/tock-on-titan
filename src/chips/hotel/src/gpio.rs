...
pub static mut PORT0 : Port = Port {
    pins: [
        GPIOPin::new(GPIO0_BASE, Pin::P0),  GPIOPin::new(GPIO0_BASE, Pin::P1),
        GPIOPin::new(GPIO0_BASE, Pin::P2),  GPIOPin::new(GPIO0_BASE, Pin::P3),
        GPIOPin::new(GPIO0_BASE, Pin::P4),  GPIOPin::new(GPIO0_BASE, Pin::P5),
        GPIOPin::new(GPIO0_BASE, Pin::P6),  GPIOPin::new(GPIO0_BASE, Pin::P7),
        GPIOPin::new(GPIO0_BASE, Pin::P8),  GPIOPin::new(GPIO0_BASE, Pin::P9),
        GPIOPin::new(GPIO0_BASE, Pin::P10), GPIOPin::new(GPIO0_BASE, Pin::P11),
        GPIOPin::new(GPIO0_BASE, Pin::P12), GPIOPin::new(GPIO0_BASE, Pin::P13),
        GPIOPin::new(GPIO0_BASE, Pin::P14), GPIOPin::new(GPIO0_BASE, Pin::P15),
    ]
};
