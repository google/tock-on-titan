...
$(BUILD_PLATFORM_DIR)/libhotel.rlib: $(call rwildcard,$(SRC_DIR)chips/hotel,*.rs) $(BUILD_PLATFORM_DIR)/libcore.rlib $(BUILD_PLATFORM_DIR)/libhil.rlib $(BUILD_PLATFORM_DIR)/libcommon.rlib | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
